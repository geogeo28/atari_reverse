...
MIRRORS = (
    ...
    ("A_key_bits", "include/hud.h", "A_key_bits"),
    ("A_joy1_state", "include/hud.h", "A_joy1_state"),
    ...
    "CONST_WORD_BYTES", "LIVES_AFTER_GAME_OVER", "BOMBS_AFTER_GAME_OVER",
    ...
    "A_level_just_started", "A_joy0_state", "A_use_keyboard_flag",
    "A_key_last_scancode",
