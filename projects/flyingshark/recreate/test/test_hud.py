...
MIRRORS = (
    ...
    "TEXT_TAB_WIDTH", ("A_joy1_state", "include/irq.h", "A_joy1_state"),
    "JOY_FIRE_BIT", "FIRE_RELEASE_WAIT_PC", "FORMAT_DIGITS",
    ...
    ("A_map_row_ptr_reset", "include/scroll.h", "A_map_row_ptr_reset"),
    ("A_scroll_fine", "include/scroll.h", "A_scroll_fine"),
    ("A_scroll_pos", "include/scroll.h", "A_scroll_pos"), "CONSOLE_TEXT_END",
)
