...
**Verified: 8/75.** The 75 are the functions in `../decomp.c`'s inventory; `../names.txt` is the
...
| `0x102e2` | `fill_screen` | 28 | ⬜ pending | |
...
| `0x1033e` | `count_objects_and_pad` | 236 | ⬜ pending | |
...
| `0x10700` | `draw_string` | 622 | ⬜ pending | |
...
| `0x12914` | `draw_egg_sprite` | 160 | ⬜ pending | |
| `0x129b4` | `erase_egg_sprite` | 118 | ⬜ pending | |
...
| `0x13300` | `check_platform` | 118 | ⬜ pending | |
| `0x135f4` | `select_sprite_base` | 52 | ⬜ pending | |
| `0x13628` | `draw_spawn_sparkle` | 116 | ⬜ pending | |
| `0x1369c` | `blit_pattern_rows` | 76 | ⬜ pending | |
| `0x136e8` | `draw_object_data` | 212 | ⬜ pending | |
| `0x137bc` | `draw_object_mask` | 134 | ⬜ pending | |
| `0x13842` | `collision_check` | 1712 | ⬜ pending | |
| `0x13ef2` | `test_overlap` | 244 | ⬜ pending | |
| `0x13fe6` | `pixel_collision` | 178 | ⬜ pending | |
| `0x14098` | `start_death_anim` | 102 | ⬜ pending | |
| `0x140fe` | `joust_bounce` | 96 | ⬜ pending | |
...
| `0x15098` | `blit_mask_wide` | 116 | ⬜ pending | |
| `0x1510c` | `blit_sprite_planes` | 202 | ⬜ pending | |
| `0x15226` | `ptero_avoid_platform` | 80 | ⬜ pending | |
| `0x15276` | `ptero_spot_player` | 72 | ⬜ pending | |
| `0x17438` | `dissolve_platforms` | 322 | ⬜ pending | |
| `0x1757a` | `raise_floor` | 64 | ⬜ pending | |
| `0x175ba` | `paint_floor_row` | 36 | ⬜ pending | |
| `0x175de` | `animate_ground_shrink` | 372 | ⬜ pending | |
| `0x17752` | `blit_sprite_mask` | 80 | ⬜ pending | |
| `0x177a2` | `blit_sprite` | 154 | ⬜ pending | |
