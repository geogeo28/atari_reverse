...
This is the playable game. It runs on a real ST/STE and in Hatari.
...
game needs **low resolution** (320x200, 16 colours) and about 1 MB of RAM, and binds the STE blitter
...
are in [`render/atari/README.md`](render/atari/README.md).
