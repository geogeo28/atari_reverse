...
scene tier returns in place of the transfers it declines to follow, which are C-only for the same
reason. All four are scraped into ONE namespace — every name is
