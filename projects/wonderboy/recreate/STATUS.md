...
**Verified: 249/? — the .RAD depacker (216 bytes), the first gameplay batch (434 bytes), the status
...
publishes a word of the record it just allocated) —
30,456 bytes in all, 68.8 % of everything
